...
DB_POOL_MAX_TOTAL=${DB_POOL_MAX_TOTAL:-$DB_POOL_MAX_ACTIVE}
DB_POOL_MAX_WAIT_MILLIS=${DB_POOL_MAX_WAIT_MILLIS:-$DB_POOL_MAX_WAIT}
...
DB_POOL_MAX_TOTAL_ESC=$(xml_escape "$DB_POOL_MAX_TOTAL")
DB_POOL_MAX_WAIT_MILLIS_ESC=$(xml_escape "$DB_POOL_MAX_WAIT_MILLIS")

if [ "$TOMCAT_MAJOR" -ge 8 ]; then
  POOL_ATTRS="maxTotal=\"${DB_POOL_MAX_TOTAL_ESC}\" maxIdle=\"${DB_POOL_MAX_IDLE_ESC}\" maxWaitMillis=\"${DB_POOL_MAX_WAIT_MILLIS_ESC}\""
else
