...
This folder contains **5 project states** ready for your demo tomorrow.
...
| **4-java21-upgraded** | `java21-upgraded` | Spring Boot 3.x + Java 21 | Part 4-5: Results & Azure Deploy |
...
```bash
cd ~/App-Modernization-Demo
code --add 1-struts-original --add 2-struts-live-demo --add 3-springboot-live-upgrade --add 4-java21-upgraded
```
...
- Show final code, run tests, start application

### **[45-55 min] Azure Deployment**
- **Use:** `4-java21-upgraded`
- Container Assist for deployment, push to Azure
